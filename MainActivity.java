...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dknim = (EditText) findViewById(R.id.d_nim);
        dknama = (EditText) findViewById(R.id.d_nama);
        dkkelas = (EditText) findViewById(R.id.d_kelas);
        dktanggal = (EditText) findViewById(R.id.d_tanggal);
